...
If checkPyw = 0 Then
    WshShell.Run "cmd /c pythonw parallel_launcher.py 3", 0, False
ElseIf checkPy = 0 Then
    WshShell.Run "cmd /c python parallel_launcher.py 3", 0, False
ElseIf checkPyLauncher = 0 Then
    WshShell.Run "cmd /c py parallel_launcher.py 3", 0, False
Else
