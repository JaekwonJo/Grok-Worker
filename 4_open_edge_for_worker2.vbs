...
configPath = basePath & "\grok_worker_config_worker2.json"
...
launcherCmd = ""
If checkPyw = 0 Then
    launcherCmd = "pythonw """ & basePath & "\edge_launcher.py"" --port 9223 --profile-dir """ & profilePath & """ --config """ & configPath & """ --url ""https://grok.com/imagine"""
ElseIf checkPy = 0 Then
    launcherCmd = "python """ & basePath & "\edge_launcher.py"" --port 9223 --profile-dir """ & profilePath & """ --config """ & configPath & """ --url ""https://grok.com/imagine"""
ElseIf checkPyLauncher = 0 Then
    launcherCmd = "py """ & basePath & "\edge_launcher.py"" --port 9223 --profile-dir """ & profilePath & """ --config """ & configPath & """ --url ""https://grok.com/imagine"""
End If
If launcherCmd <> "" Then
